...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('DashBoard', '0016_auto_20171028_1523'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='Customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='id', to='DashBoard.QWERTYCustomer'),
        ),
        migrations.AlterField(
            model_name='qwertybilling',
            name='saletime',
        ...
        migrations.AddField(
            ...
            name='Customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='id', to='DashBoard.SAMRCustomer'),
        ),
        migrations.AddField(
