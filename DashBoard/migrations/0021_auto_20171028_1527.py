...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('DashBoard', '0020_auto_20171028_1527'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='Customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Customer_id', to='DashBoard.QWERTYCustomer'),
        ),
        migrations.AddField(
